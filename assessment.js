...
var responseCreator = function(param){ if (param === 'green'){colorResponse = 'Green is okay'}else if(param === 'red'){colorResponse = 'I heart red'}else {colorResponse = 'What is your favorite color?'}; return colorResponse;
  // CODE HERE
}
